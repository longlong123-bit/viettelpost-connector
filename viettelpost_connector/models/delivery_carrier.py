...
class DeliveryCarrier(models.Model):
    ...
    vtp_province_ids = fields.One2many('viettelpost.province', 'delivery_carrier_id', string='Provinces')
    vtp_district_ids = fields.One2many('viettelpost.district', 'delivery_carrier_id', string='Districts')
    vtp_ward_ids = fields.One2many('viettelpost.ward', 'delivery_carrier_id', string='Wards')
